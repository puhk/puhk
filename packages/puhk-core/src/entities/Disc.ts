...
export default class Disc {
	...
	public clone(): Disc {
		const clone = new Disc(this.position.clone(), this.radius, this.color, this.damping, this.invMass, this.id);
	...
	public static parse(obj: JsonDisc): Disc {
		const disc = new Disc(Vec.fromArray(obj.pos), obj.radius, obj.color, obj.damping, obj.invMass, obj.id);
